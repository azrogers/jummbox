import{H as ee,C as o,f as te,S as g,a as d}from"./synth-Q-SpOrBu.js";const{a:P,button:D,div:k,h1:Le,input:Ce}=ee,{svg:V,circle:Be,rect:K,path:W}=g;document.head.appendChild(ee.style({type:"text/css"},`
	body {
		color: ${o.primaryText};
